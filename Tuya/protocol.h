...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "7xd27dnrrwt6t34m"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//杀菌消毒状态(只上报)
//备注:
#define DPID_UV_STATE 12
//香薰状态(只上报)
//备注:
#define DPID_FRAGRANCE_STATE 13
//香薰(可下发可上报)
//备注:
#define DPID_FRAGRANCE 14
//启动(可下发可上报)
//备注:
#define DPID_START 15
//暂停/继续(可下发可上报)
//备注:
#define DPID_PAUSE 16
//工作状态(只上报)
//备注:
#define DPID_WORK_STATE 21
//当前湿度(只上报)
//备注:
#define DPID_HUMIDITY_CURRENT 22
//TVOC(只上报)
//备注:
#define DPID_TVOC 101
//CH2O(只上报)
//备注:
#define DPID_CH2O 102
//CO2(只上报)
//备注:
#define DPID_CO2 103
//目标温度(可下发可上报)
//备注:
#define DPID_TEMP_TARGET 104
//报警提示音(可下发可上报)
//备注:用于发出蜂鸣器报警提示音，1为报警；0为无警报
#define DPID_ALARM_BEEP 105
//热敏ntc(只上报)
//备注:
#define DPID_NTC 106
